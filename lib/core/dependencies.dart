...
import 'package:recipe_app/features/profiles/data/repositories/my_profile_repository.dart';
...
List<SingleChildWidget> providers = [
  ...
  Provider(create: (context)=>MyProfileRepository(client: context.read())),
